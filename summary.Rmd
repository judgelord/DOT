...
Notice how the DOT (esp. FTA and FHA) initiated a large number of projects shortly after Obama's reelection, probably waiting for assureance that they would be able to complete their work.  
...
```{r hist-promting-action}
  ...
  ggplot() +  
  geom_density(aes(initiated)) + 
    # geom_histogram(aes(initiated), bins = 116, na.rm = T ) +
  labs(title = "Rulemaking Projects Initiated", x = "")
```
