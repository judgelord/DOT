...
Formatting data for multi-stage duration modeling requires identifying the dates of transitions to and from each stage. 
...
# ALL OBS ARE TRANSITIONS, HOWEVER, WE CAN INCLUDE NON TRANSITION OBS -- DOES IT HELP? 
d$status <- 1
```
...
# CAUTION NOTE: in the first run, Withdrawals got dropped, making 4 (NPRM to Final) the 3rd factor
f <- fit$Haz
